...
const DISTRICT_COLORS := {
	...
	"civic_medical": Color(0.30, 0.22, 0.31, 0.88),
	"south_residential": Color(0.31, 0.27, 0.19, 0.88),
	"outer_residential": Color(0.25, 0.30, 0.21, 0.88),
	"south_industrial": Color(0.28, 0.30, 0.33, 0.88),
	"logistics_belt": Color(0.23, 0.29, 0.33, 0.88),
	"power_plant": Color(0.32, 0.28, 0.24, 0.88),
	"rural_greenbelt": Color(0.20, 0.31, 0.23, 0.88),
	"highway_checkpoint": Color(0.28, 0.25, 0.20, 0.88),
