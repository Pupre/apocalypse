...
const PATH_ALIASES := {
	...
	"sheet/loadout_panel_expanded.png": "@master/sheet/loadout_panel_expanded.png",
	"sheet/inventory_filter_rail.png": "@master/sheet/inventory_filter_rail.png",
	"sheet/sheet_button_primary_normal.png": "@master/sheet/sheet_button_primary_normal.png",
	"sheet/sheet_button_primary_pressed.png": "@master/sheet/sheet_button_primary_pressed.png",
	...
	"sheet_set/action_button_primary_normal.png": "sheet/sheet_button_primary_normal.png",
	"sheet_set/action_button_primary_pressed.png": "sheet/sheet_button_primary_pressed.png",
	...
	"indoor/indoor_action_row_compact_idle.png": "@master/indoor/indoor_action_row_compact_idle.png",
	"indoor/indoor_action_row_compact_pressed.png": "@master/indoor/indoor_action_row_compact_pressed.png",
	"indoor/indoor_action_row_risk_idle.png": "@master/indoor/indoor_action_row_risk_idle.png",
	"indoor/indoor_action_row_risk_pressed.png": "@master/indoor/indoor_action_row_risk_pressed.png",
	"indoor/indoor_action_row_loot_idle.png": "@master/indoor/indoor_action_row_loot_idle.png",
	"indoor/indoor_action_row_loot_pressed.png": "@master/indoor/indoor_action_row_loot_pressed.png",
	"indoor/indoor_action_row_locked_idle.png": "@master/indoor/indoor_action_row_locked_idle.png",
	...
	"indoor/indoor_event_office_records.png": "@master/indoor/indoor_event_office_records.png",
	...
	"indoor/indoor_story_logistics_cold_chain_choice.png": "@master/indoor/indoor_story_logistics_cold_chain_choice.png",
	"indoor/indoor_story_logistics_dispatch_routes_success.png": "@master/indoor/indoor_story_logistics_dispatch_routes_success.png",
	"indoor/indoor_story_logistics_pallet_crash_failure.png": "@master/indoor/indoor_story_logistics_pallet_crash_failure.png",
	"indoor/indoor_story_power_control_warmth_success.png": "@master/indoor/indoor_story_power_control_warmth_success.png",
	"indoor/indoor_story_power_heat_trace_note_success.png": "@master/indoor/indoor_story_power_heat_trace_note_success.png",
	"indoor/indoor_story_power_pipe_gallery_slip_failure.png": "@master/indoor/indoor_story_power_pipe_gallery_slip_failure.png",
	"indoor/indoor_story_greenhouse_seed_cache_success.png": "@master/indoor/indoor_story_greenhouse_seed_cache_success.png",
	"indoor/indoor_story_greenhouse_fast_strip_failure.png": "@master/indoor/indoor_story_greenhouse_fast_strip_failure.png",
	"indoor/indoor_story_greenhouse_water_barrel_success.png": "@master/indoor/indoor_story_greenhouse_water_barrel_success.png",
	"indoor/indoor_story_checkpoint_detour_choice.png": "@master/indoor/indoor_story_checkpoint_detour_choice.png",
	"indoor/indoor_story_checkpoint_exposed_crossing_failure.png": "@master/indoor/indoor_story_checkpoint_exposed_crossing_failure.png",
	"indoor/indoor_story_checkpoint_bus_seat_cache_success.png": "@master/indoor/indoor_story_checkpoint_bus_seat_cache_success.png",
	"indoor/indoor_story_civic_triage_sort_choice.png": "@master/indoor/indoor_story_civic_triage_sort_choice.png",
	"indoor/indoor_story_civic_triage_gloved_sort_success.png": "@master/indoor/indoor_story_civic_triage_gloved_sort_success.png",
	"indoor/indoor_story_civic_triage_fast_sweep_failure.png": "@master/indoor/indoor_story_civic_triage_fast_sweep_failure.png",
	"indoor/indoor_story_shelter_registration_choice.png": "@master/indoor/indoor_story_shelter_registration_choice.png",
	"indoor/indoor_story_shelter_personal_share_success.png": "@master/indoor/indoor_story_shelter_personal_share_success.png",
	"indoor/indoor_story_shelter_empty_boxes_failure.png": "@master/indoor/indoor_story_shelter_empty_boxes_failure.png",
	"indoor/indoor_story_outer_garage_sling_success.png": "@master/indoor/indoor_story_outer_garage_sling_success.png",
	"indoor/indoor_story_rest_stop_vending_choice.png": "@master/indoor/indoor_story_rest_stop_vending_choice.png",
	"indoor/indoor_story_rest_stop_vending_panel_success.png": "@master/indoor/indoor_story_rest_stop_vending_panel_success.png",
	"indoor/indoor_story_rest_stop_vending_glass_failure.png": "@master/indoor/indoor_story_rest_stop_vending_glass_failure.png",
	"indoor/indoor_story_parcel_route_sort_choice.png": "@master/indoor/indoor_story_parcel_route_sort_choice.png",
	"indoor/indoor_story_parcel_route_map_success.png": "@master/indoor/indoor_story_parcel_route_map_success.png",
	"indoor/indoor_story_parcel_random_boxes_failure.png": "@master/indoor/indoor_story_parcel_random_boxes_failure.png",
	"indoor/indoor_story_farm_storage_weight_choice.png": "@master/indoor/indoor_story_farm_storage_weight_choice.png",
	"indoor/indoor_story_substation_breaker_choice.png": "@master/indoor/indoor_story_substation_breaker_choice.png",
	"indoor/indoor_story_school_cafeteria_ration_choice.png": "@master/indoor/indoor_story_school_cafeteria_ration_choice.png",
	"indoor/indoor_story_bus_depot_route_fuel_choice.png": "@master/indoor/indoor_story_bus_depot_route_fuel_choice.png",
	"indoor/indoor_story_public_health_cold_room_choice.png": "@master/indoor/indoor_story_public_health_cold_room_choice.png",
	"indoor/indoor_story_shelter_water_checkpoint_choice.png": "@master/indoor/indoor_story_shelter_water_checkpoint_choice.png",
	"indoor/indoor_story_shelter_water_prefilter_success.png": "@master/indoor/indoor_story_shelter_water_prefilter_success.png",
	"indoor/indoor_story_shelter_water_heavy_take_failure.png": "@master/indoor/indoor_story_shelter_water_heavy_take_failure.png",
	"indoor/indoor_story_forklift_workshop_carry_choice.png": "@master/indoor/indoor_story_forklift_workshop_carry_choice.png",
	"indoor/indoor_story_noisy_scavenge_failure.png": "@master/indoor/indoor_story_noisy_scavenge_failure.png",
	"indoor/indoor_story_overburdened_exit_failure.png": "@master/indoor/indoor_story_overburdened_exit_failure.png",
